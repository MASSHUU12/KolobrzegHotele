...
<section class="info-page">
    <div class="info-page-inner">
        <div class="info-title">
            <div>
                ...
                <p>
                    ...
                    {{ __("wszystkich podstron tego serwisu.") }}
                </p>
            </div>
        </div>
        <div class="info-top">
            <div class="info-main-image">
                ...
                >
                    ...
                    <path
                        fill="#6d4934"
                        d="M22.74 16.112l1.98-1.98l1.98 1.98l-1.98 1.98z"
                    />
                    <g fill="#dda85f">
                        <path
                            d="M14.706 33.483l1.979-1.98l1.98 1.979l-1.979 1.98z"
                        />
                        <path
                            d="M34.698 44.811l1.98-1.98l1.98 1.98l-1.98 1.98z"
                        />
                        <path
                            d="M32.038 39.289l2.687-2.687l2.687 2.687l-2.687 2.687z"
                        />
                        <path
                            d="M24.696 9.827l2.687-2.687l2.687 2.687l-2.687 2.687z"
                        />
                    </g>
                    <g fill="#6d4934">
                        <path
                            d="M41.122 46.347l1.98-1.98l1.98 1.98l-1.98 1.98z"
                        />
                        <path
                            d="M49.076 35.215l1.98-1.98l1.98 1.98l-1.98 1.98z"
                        />
        ...
        <div class="info-long">
            <article>
                <h3>
                    {{ __('W jaki sposób wykorzystujemy pliki "cookies"?') }}
                </h3>
                <p>
                    {{
                        __(
                            'Pliki "cookies" używane są przez nas do przechowywania informacji o tym które powiadomienia zostały już przez użytkownika zamknięte np. powiadomienie o cookies, te informacje są przechowywane lokalnie na komputerze użytkownika i nie wykorzystujemy ich w żaden nieodpowiedni sposób, mają służyć tylko i wyłącznie wygodzie użytkownika.'
                        )
                    }}
                </p>
            </article>
            <article>
                ...
                <p>
                    {{
                        __(
                            'Stosowane są przez nas pliki "stałe", pozostają one na urządzeniu użytkownika przez czas określony w parametrach plików "cookies" lub do momentu ich ręcznego usunięcia przez użytkownika.'
                        )
                    }}
                </p>
            </article>
            <article>
                ...
                <p>
                    {{
                        __(
                            "Nie, żadne informacje przechowywane w tych plikach nie są danymi osobowymi ani nie pozwalają na zidentyfikowanie użytkownika. Znajdują się w nich tylko i wyłącznie informacje pozwalające na wyświetlenie zapisanych ofert."
                        )
                    }}
                </p>
            </article>

<form action="/search" method="get" data-swup-form>
    <div class="searchbar">
        ...
        <div class="searchbar-filter">
            <input type="hidden" name="bike" class="search-input">
        ...
        <div class="searchbar-filter">
            <input type="hidden" name="playground" class="search-input">
        ...
        <button class="searchbar-button button-primary"><span class="iconify" data-icon="ant-design:search-outlined" data-inline="false" id="search-iconify"></span>&nbsp;&nbsp;&nbsp;&nbsp;szukaj</button>
    </div>
</form>
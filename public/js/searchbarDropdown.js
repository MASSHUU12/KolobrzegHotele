function searchbarDropdown() {
    ...
    if (url == "" || url == "search" || url == "/" || url == "search/") {
        ...
        filterBoxes.forEach((filterBox) => {
            ...
            if (
                inputTextValue.innerHTML != "bez znaczenia" ||
                inputTextValue.innerHTML != "does not matter"
            ) {
            ...
            filterBox.addEventListener("click", () => {
                ...
                if (dropdown[0].classList.contains("trigger-flex")) {
                    ...
                    var endValue =
                        filterBox.querySelectorAll(".filter-end-value");
                    ...
                    var options = dropdown[0].querySelectorAll(
                        ".filter-dropdown-element"
                    );
                    var hiddenInput =
                        filterBox.querySelectorAll(".search-input");
